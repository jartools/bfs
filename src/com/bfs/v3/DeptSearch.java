...
public class DeptSearch
{
	 ...
	 */
	void widthSearch(NodeT start,NodeT end){
		List<NodeT> visited = new ArrayList<NodeT>();
		...
		Map<NodeT, NodeT> path = new HashMap<NodeT, NodeT>();
		NodeT cur,to;
		while(!q.isEmpty()){
			cur = q.poll();
			//被访问过了，就不访问，防止死循环
