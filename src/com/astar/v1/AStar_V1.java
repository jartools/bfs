...
public class AStar_V1 {
	// 来源地址 ： http://joshuasabrina.iteye.com/blog/1811065
	// 迷宫图
	Point[][] maze;
	// 起始节点
	Point start;
	 ...
	 * 打印行走路径
	 * 
	 * 经过的点用'*'表示, 未经过的点用'.'表示， 起始节点用'r'表示, 目的节点用'a'表示 士兵用'x'表示
	 */
	 ...
	 *            目的节点
	 */
	public AStar_V1(Point[][] maze, Point start, Point goal) {
		this.maze = maze;
		this.start = start;
		this.goal = goal;
	...
	public static void main(String[] args) {
		...
		AStar_V1 astar = new AStar_V1(maze, start, goal);
		// 启动搜索迷宫过程
		astar.start();
		// 打印行驶路径
		astar.printPath();
